...
#define ENABLE_NV_MESH_SHADER 1

class GLProgram
{
public:
    enum ShaderType { VERTEX_SHADER = 0, GEOMETRY_SHADER, FRAGMENT_SHADER, TESS_CONTROL_SHADER, TESS_EVALUATION_SHADER, COMPUTE_SHADER, TASK_SHADER, MESH_SHADER, NUM_SHADER_TYPE };

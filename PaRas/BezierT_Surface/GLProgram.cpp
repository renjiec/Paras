...
const char *const GLProgram::ShaderTypeStrs[NUM_SHADER_TYPE] = { "Vertex Shader", "Geometry Shader", "Tesselation Control Shader", "Tesselation Evaluation Shader", "Fragment Shader", "Compute Shader", "Task Shader", "Mesh Shader"};
